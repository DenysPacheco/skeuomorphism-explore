                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        data.forEach((el) => {
                            ...
                            stringList += `<li><i class='fas fa-folder me-3'></i><a href='${el.html_url}' target='_blank'>${el.name}</a></li>`
                        })
...
function getProfile() {
    ...
    if (username !== '') {
        ...
        DOMToggleLoadingSpinner('list-spinner')
        DOMRemoveListRepos()
        // DOMToggleLoadingSpinner('phrase-spinner')
        typewatch(() => {
            // Whatever you want to trigger paste it here.
            const fetchUsers = () => {
                axios
...
function DOMAddListRepos(stringList) {
    document.getElementById('list-repos').style.overflow = 'auto'
    document.getElementById('list-repos').innerHTML = stringList
}

function DOMRemoveListRepos() {
    document.getElementById('list-repos').style.overflow = 'hidden'
